...
export const FounderSection = () => {
  const founder = {
    ...
    bioParagraphs: [
      ...
      "His passion for prophetic worship has ignited a movement that continues to shape communities and transform lives across the globe. Through his Ministration, countless souls have experienced the healing and liberating power of worship in its purest form.",
